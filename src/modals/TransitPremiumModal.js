...
const TransitPremiumModal = ({handleCloseSolarPremiumModal, visible}) => {
...
const handlePurchase = async () => {
  ...
  return (
      ...
      <Text style={styles.modalPremiumTitle}>{t("pricing.transitTitle")}</Text>
      <Text style={styles.modalPremiumSubtitle}>{t("pricing.transitSubtitle")} <Text style={styles.modalPremiumSubtitleBold}>{t("pricing.solarSubtitleBold")}</Text></Text>
...
export default TransitPremiumModal;
