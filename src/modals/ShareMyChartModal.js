...
const ShareMyChartModal = ({visible, fechaTransito, handleCloseModal, year, formattedDate, formattedTime, selectedPlanet, selectedNatalPlanet,selectedTransitPlanet }) => {
                ...
                <View >
                  ...
                  <Svg width="400" height="400">
                                ...
                                {planetasYPuntos.map((cuerpo, index) => {
                                  ...
                                  const isSelected = cuerpo === selectedPlanet; 
                                  ...
                                  const circleFillColor = esAscendenteOMedioCielo
                                    ? (isSelected ? theme.focusedItem : theme.tertiary) 
                                    : 'none'; 
...
{fechaTransito ? (
  ...
  <View style={styles(theme).shareChartDetailsHeader}>
    <View style={styles(theme).shareChartTitle}>
      {year ? (
        <Text style={styles(theme).shareChartTitleText}>
          {i18n.language === 'es' ? `Mi Revolución Solar ${year}` : `My Solar Return ${year}`}
        </Text>
      ) : (
        <Text numberOfLines={1} ellipsizeMode="tail" style={styles(theme).shareChartTitleText}>
    ...
    <View style={styles(theme).shareChartInfo}>
      ...
      <Text style={styles(theme).shareChartInfoTime}>
        {year ? (
            ...
            userData?.birthTime // Original logic for birth time
        )}
      </Text>
      <View style={styles(theme).shareChartInfoSeparator} />
